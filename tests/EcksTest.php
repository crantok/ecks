...
class EcksTest extends PHPUnit_Framework_TestCase
{
    ...
    function testEcks()
    {
        ...
        $this->assertEquals( 13, ecks([2,4,7])->reduce( function($red,$val){return $red+$val;} ) );
        $this->assertEquals( 23, ecks([2,4,7])->reduce( function($red,$val){return $red+$val;}, 10 ) );
        $this->assertEquals( 56, ecks([2,4,7])->reduce( function($red,$val){return $red*$val;}, 1 ) );
        $this->assertEquals( 56, ecks([2,4,7])->reduce( function($red,$val){return $red*$val;} ) );
        $this->assertEquals( 560, ecks([2,4,7])->reduce( function($red,$val){return $red*$val;}, 10 ) );
